...
for k=1:N-1
    j=k+1;
     ...
     if(k~=1 && k~=N-1)
        if(k~=N/2)
             d1(k,1)=del_t*func1(x(k+1),t(i))+U1(k+1,i-1);
             d2(k,1)=del_t*func2(x(k+1),t(i))+U2(k+1,i-1);
        end
        if(k==N/2)
            d1(k,1)=0;
            d2(k,1)=0;
     ...
     if(k==1)
         %a11=(1+x(2));
         %a12=(1+x(2)^2);
         d1(k,1)=del_t*func1(x(k+1),t(i))+del_t*(2*e1/(c*b))*U1(1,i-1);
         d2(k,1)=del_t*func2(x(k+1),t(i))+del_t*(2*e2/(c*b))*U2(1,i-1);
     end
     if(k==N-1)
         %a21=-(2+x(N));
        % a22=-(2+x(N)^2);
        d1(k,1)=del_t*func1(x(k+1),t(i))+del_t*(2*e1/(c*f))*U1(N+1,i-1);
        d2(k,1)=del_t*func2(x(k+1),t(i))+del_t*(2*e2/(c*f))*U2(N+1,i-1);
     end
