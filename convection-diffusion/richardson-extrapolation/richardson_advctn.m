...
U1_extrp=2*G1(1:2:Nx+1,1:2:Nt+1)-F1;
U2_extrp=2*G2(1:2:Nx+1,1:2:Nt+1)-F2;
  %%%%%%%%%%%%%%%%%%%%%
   err1_normal=abs(F1-U1_exct(1:2:Nx+1,1:2:Nt+1));
   err1_extrp=abs(U1_extrp-U1_exct(1:2:Nx+1,1:2:Nt+1));
%   %err1=abs(F1-G1(1:2:Nx+1,1:2:Nt+1));
%     err_sup1=max(err1);
%          max_err1=max(err_sup1);
%        error1(ep_counter,N_counter)=max_err1;
%        
          err2_normal=abs(F2-U2_exct(1:2:Nx+1,1:2:Nt+1));
           err2_extrp=abs(U2_extrp-U2_exct(1:2:Nx+1,1:2:Nt+1));
