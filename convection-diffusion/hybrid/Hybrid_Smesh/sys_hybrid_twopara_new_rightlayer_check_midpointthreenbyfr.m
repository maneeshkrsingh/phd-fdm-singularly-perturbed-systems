...
sig2=min(1/2,2.2*e2*log(Nx1));
sig1=min(sig2/2,2.2*(e1)*log(Nx1));
% sig2=0.0024;
% sig1=0.0014;
for l=1:2
     Nx=Nx1*2^(l-1);
...
for j=2:Nt+1
for i=3:Nx-1
    A(i-1,i-2)=k*(-(2*e1/(h(i-1)*(h(i-1)+h(i))))-(((3+x(i))+(3+x(i-1)))/(2*h(i-1)))+((2+x(i))+(2+x(i-1)))/2)+(1/2);
    A(i-1,i-1)=k*((2*e1/(h(i-1)*h(i)))+(((3+x(i))+(3+x(i-1)))/(2*h(i-1)))+((2+x(i))+(2+x(i-1)))/2)+(1/2);
...
% end
% for i=(3*Nx/4)+2:Nx-1
%     A(i-1,i-2)=k*(-(2*e1/(h(i-1)*(h(i-1)+h(i))))-((3+x(i))/(h(i-1)+h(i))));
%     A(i-1,i-1)=k*((2*e1/(h(i-1)*h(i)))+(2+x(i)))+1;
%     A(i-1,i)=k*(-(2*e1/(h(i)*(h(i-1)+h(i))))+((3+x(i))/(h(i-1)+h(i))));
%end
i=2;
    A(i-1,i-1)=k*((2*e1/(h(i-1)*h(i)))+(((3+x(i))+(3+x(i-1)))/(2*h(i-1)))+((2+x(i))+(2+x(i-1)))/2)+(1/2);
    A(i-1,i)=-k*(2*e1/(h(i)*(h(i-1)+h(i))));
 ...
 for i=3:Nx-1
    D(i-1,i-2)=k*(-(2*e2/(h(i-1)*(h(i-1)+h(i))))-(((3+2*x(i))+(3+2*x(i-1)))/(2*h(i-1)))+((2+2*x(i))+(2+2*x(i-1)))/2)+(1/2);
    D(i-1,i-1)=k*((2*e2/(h(i-1)*h(i)))+(((3+2*x(i))+(3+2*x(i-1)))/(2*h(i-1)))+((2+2*x(i))+(2+2*x(i-1)))/2)+(1/2);
...
% for i=(3*Nx/4)+2:Nx-1
%     D(i-1,i-2)=k*(-(2*e2/(h(i-1)*(h(i-1)+h(i))))-((3+2*x(i))/(h(i-1)+h(i))));
%     D(i-1,i-1)=k*((2*e2/(h(i-1)*h(i)))+(2+2*x(i)))+1;
%     D(i-1,i)=k*(-(2*e2/(h(i)*(h(i-1)+h(i))))+((3+2*x(i))/(h(i-1)+h(i))));
% end
i=2;
   D(i-1,i-1)=k*((2*e2/(h(i-1)*h(i)))+(((3+2*x(i))+(3+2*x(i-1)))/(2*h(i-1)))+((2+2*x(i))+(2+2*x(i-1)))/2)+(1/2);
    D(i-1,i)=-k*(2*e2/(h(i)*(h(i-1)+h(i))));
...
%  end
 ...
 for i=3:Nx-1
     C(i-1,i-2)=-k*(x(i)+x(i-1))/4;
     C(i-1,i-1)=-k*(x(i)+x(i-1))/4;
     C(i-1,i)=0;
  end    
%  for i=3:3*Nx/4+1
%      C(i-1,i-2)=-k*(x(i)+x(i-1))/4;
