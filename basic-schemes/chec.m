...
for i=3:Nx/2
    A(i-1,i-2)=-k*((2*e/(h(i-1))*(h(i)+h(i-1)))-((a(i)+a(i-1)))/2*(h(i-1)))+0.5;
   A(i-1,i-1)=k*((2*e/(h(i+1)*h(i)))+((a(i)+a(i-1))/2*(h(i))))+0.5;
    A(i,i-1)=-k*(2*e/(h(i)*(h(i)+h(i-1))));
end
for i=(Nx/2)+1:Nx-1
     A(i-1,i-2)=-k*((2*e/(h(i-1)*(h(i)+h(i-1))))-(a(i-1)/(h(i)+h(i-1))));
    A(i-1,i-1)=k*(2*e/(h(i)*h(i-1)))+1;
    A(i-1,i)=-k*((2*e/(h(i)*(h(i)+h(i-1))))+(a(i-1)/(h(i)+h(i-1))));
end
i=2;
    A(i-1,i-1)=k*((2*e/(h(i+1)*h(i)))+((a(i)+a(i-1))/2*(h(i))))+0.5;
    A(i,i-1)=-k*(2*e/(h(i)*(h(i)+h(i-1))));
